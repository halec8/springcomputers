...
public class ComputersApplication {
	...
	/*
	 * @Autowired ComputersRepository repo;
	 * 
	 ...
	 * ShippingAddress shipAddress = new ShippingAddress("123 Westown Pkwy",
	 * "West Des Moines", "IA");
	 * 
	 * c2.setShippingAddress(shipAddress); repo.save(c2);
	 * 
	 * List<Computers> allComputers = repo.findAll(); for (Computers computers :
	 * allComputers) { System.out.println(computers.toString());
	 * 
