...
public class Computers {
	...
	//will be a unqiue id that will identify each added computer
	@Id
	@GeneratedValue
	private long id;
	...
	public String toString() {
		return "Computer [id = " + id + ", type = " + type + ", brand = " + brand + ", model = " + model + ", year released = " + yearReleased + ", screen size = " +
	screenSize + "] " + "Shipping Address: " + shippingAddress;
	}
